...
İletişim               </span>
               <h2
                  ...
                  "
                  >
BİZİMLE İLETİŞİME GEÇİN               </h2>
               <p class="text-base text-body-color leading-relaxed mb-9">
               Bizimle iletişime geçmek için aşağıdaki iletişim formu, mail adresi ve telefon numarasını kullanabilirsiniz.
               ...
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-dark text-xl mb-1">Adres</h4>
                     <p class="text-base text-body-color">
                     Özsan Sanayi sitesi 11. Blok No:5 Yeşilyurt/ MALATYA
                     </p>
                  </div>
               </div>
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-dark text-xl mb-1">Tel</h4>
                     <p class="text-base text-body-color">0850 305 4401</p>
                     <p class="text-base text-body-color">Fabrika: 0422 238 0474 </p>
                  </div>
               </div>
               <div class="flex mb-8 max-w-[370px] w-full">
                  <div
                  ...
                  <div class="w-full">
                     ...
                     <p class="text-base text-body-color">info@bamu.com.tr</p>
                  </div>
               </div>
            </div>
            </div>
